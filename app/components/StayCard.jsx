    ...
    <div className="flex flex-col w-full group relative">
      ...
      <div className="flex flex-col mt-3">
        <div className="flex justify-between items-center w-full">
          <p className="font-normal text-sm sm:text-md">{location}</p>
          <div className="flex items-center gap-1">
            ...
            <p className="text-sm sm:text-md font-light">{ratings}</p>
          </div>
        </div>
      ...
      >
        <p className="font-medium stay-price text-sm sm:text-md cursor-pointer">
